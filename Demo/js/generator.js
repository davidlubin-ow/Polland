$(function(){
   ...
   let count = 0;
    ...
    $( '#addEmail' ).click(function() {
      $('#form-sample').append('<div class="form-group"><label for="exampleInputEmail1">Email address</label><input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"><small id="emailHelp" class="form-text text-muted">We will never share your email with anyone else.</small></div>');
    });
    ...
    $( '#addDropdown' ).click(function() {
      ...
      $(multipleChoice).append(multipleChoiceLabel).append(multipleChoiceName);
      $("#form-sample").append(multipleChoice).append(addOptionButton).append('<hr>');
    });
